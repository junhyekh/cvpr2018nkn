...
If that happens, reduce the per page amount of animations from 96 to 24, or manually enter 10 in the URL (like [this](https://www.mixamo.com/#/?page=1&type=Motion%2CMotionPack&limit=10)) - on each page turn the script waits for a couple of seconds to help with the above.

For offline browsing purposes, here's a download with all thumbnail:
Here are the Thumbnails:
[MixamoThumbnails.7z (523.28 MB)](https://1fichier.com/?iv2pmpc3ri)
...
function getUrlVars() {
    var vars = {};
    var parts = window.location.href.replace(/page*=\d*/,    
